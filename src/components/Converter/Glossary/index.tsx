...
const Glossary = () => {
  return (
    <Card data-cy="glossary-container" className="glossary-container">
      <div className="flex items-center mb-4">
        <MdOutlineHistoryEdu className="text-2xl text-slate-700 mr-2" />
        <h2
          className="text-xl font-semibold text-slate-700"
          data-cy="glossary-header"
        >
          Roman Numerals Glossary
        </h2>
      </div>
      <p
        className="mb-4 text-slate-700 flex items-center"
        data-cy="glossary-intro-text"
      >
      ...
      <Table>
        ...
        <Table.Body className="divide-y">
          <Table.Row
            ...
            data-cy="glossary-row-1"
          >
            <Table.Cell data-cy="glossary-cell-thousands">M</Table.Cell>
